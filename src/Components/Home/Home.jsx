...
<div id='color' className="w-full h-24 flex border-b-2 border-gray-400  phone:w-full phone:h-24 phone:flex  ">
    ...
    <div id='Hussain1' className="Right w-[60%] phone:w-[40%] phone:h-24 phone:flex phone:items-center phone:gap-2 phone:justify-center h-24 flex items-center justify-evenly ">
        ...
        <span className='font-bold phone:hidden '><a href="#Experience">Experience</a></span>
            ...
            <Link className='phone:flex phone:text-[13px] ' to="/Portfolio" >
                Portfolio
            </Link>
                </span>
        <span className='font-bold phone:hidden '><a href="">Testimonial</a></span>
        <button className='BTN p-2 shadow-lg shadow-[#fca61f]  rounded-full'><a href="#color2">Contact </a></button>
    </div>
</div>
</> 
 )
